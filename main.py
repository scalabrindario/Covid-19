...
def parse_argument():
	...
	parser.add_argument("country_code", help = "The country code associated with each country")
...
if country.country_code in country_check(default_csv_path + "country_list.csv"):
	if __name__ == "__main__":
		...
		if check_for_username(country.u, country.p):
			...
			country_name = country_name(default_csv_path + "country_list.csv", country.country_code)
